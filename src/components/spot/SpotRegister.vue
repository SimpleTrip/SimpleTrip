            ...
            <div class="justify-content-center">
                ...
                <div class="d-flex justify-content-center gap-2">
                    <div class="d-flex flex-column align-items-center container">
                        <div class="col-12 mb-2 mt-2">
                            <h5>Type</h5>
                            <div class="input-group input-group-outline"><label class="form-label"></label><input
                                    type="text" id="text" class="form-control form-control-md" v-model="post.type" /></div>
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-center gap-2">
                        ...
                        <div class="col-12 mb-2 mt-2">
                            ...
                            <div class="input-group input-group-outline">
                                ...
                                <textarea class="text-area form-contol form-control-md" rows="5" cols="37"
                                    style="width: 100%" v-model="post.content"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
