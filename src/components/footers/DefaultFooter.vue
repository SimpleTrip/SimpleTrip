...
defineProps({
  ...
  links: {
    ...
    href: String,
    default: () => [
      { href: 'https://edu.ssafy.com/', name: 'Company' },
      { href: 'https://lab.ssafy.com/uhyeon1009/trip_Vue_Gwangju_04_KimSuRin_ChoiJiWoong', name: 'Team' },
      { href: 'https://www.creative-tim.com/blog', name: 'Github' },
      {
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">Copyright © {{ new Date().getFullYear() }} SIMPLE TRIP by SSAFY.</p>
        </div>
      </div>
    </div>
  </footer>
