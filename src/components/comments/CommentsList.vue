...
<template>
  <div>
    <div class="container" style="overflow-y: auto; height: 440px; margin-top: 40px">
      <CommentsItems v-for="comment in commentList" :key="comment.id" :comment="comment" v-if="lengthCommentList != 0"
        @delete-comment="updateComment" @rewrite-comment="updateComment" />
    ...
    <div class="writeContainer">
      ...
      <a class="btn btn-success btn-md"
        style="margin: 4px; padding: 2px; padding-top: 5px; padding-bottom: 5px; min-width: 16%"
        @click="clickWrite">작성</a>
    </div>
  </div>
</template>
