...
<template>
  <div class="input-group">
    ...
    <input :id="id" :type="type" class="form-control" :class="[getClasses(size, success, error), inputClass]" :value="value" :placeholder="placeholder" :isRequired="isRequired" :disabled="isDisabled" />
  </div>
</template>
